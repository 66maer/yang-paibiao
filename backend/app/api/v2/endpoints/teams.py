...
async def get_heibenren_recommendations(
    ...
    for rec in recommendations:
        ...
        recommendation_items.append(HeibenRecommendationItem(
            ...
            participation_modifier=rec["participation_modifier"],
            teams_since_last_participation=rec.get("teams_since_last_participation"),
            recent_3_participations=rec.get("recent_3_participations", []),
