    ...
    const tooltipContent = (
      <div className="space-y-2 max-w-sm">
        ...
        <div className="border-t pt-2 font-semibold text-primary">
          Rank分 = {Number(detail.corrected_average_gold).toFixed(2)} × {Number(detail.rank_modifier).toFixed(4)} ={" "}
          {Number(detail.rank_score).toFixed(2)}
        </div>
      </div>
    );
              ...
              <div>
                ...
                <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg space-y-2">
                  <div className="font-mono text-sm">
                    <strong>Rank分</strong> = 修正后的平均金团金额 × Rank修正系数
                  </div>
                  <div className="font-mono text-sm">
