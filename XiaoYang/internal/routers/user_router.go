...
func userServiceMiddlewares(c *middlewareConfig) {
	...
	//c.setSinglePath("POST", "/api/v1/user/updateUserInfo", middleware.Auth())    // UpdateUserInfo 更新用户信息
	//c.setSinglePath("POST", "/api/v1/user/changePassword", middleware.Auth())    // ChangePassword 修改密码
}
