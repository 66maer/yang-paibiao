...
type Signups struct {
	...
	IsRich            *sgorm.Bool     `gorm:"column:is_rich;type:bool;not null" json:"isRich"`               // 是否是老板
	IsProxy           *sgorm.Bool     `gorm:"column:is_proxy;type:bool;not null" json:"isProxy"`             // 是否是代报名
	...
	IsDove            *sgorm.Bool     `gorm:"column:is_dove;type:bool;not null" json:"isDove"`               // 是否鸽了
	IsCandidate       *sgorm.Bool     `gorm:"column:is_candidate;type:bool;not null" json:"isCandidate"`     // 是否是替补
