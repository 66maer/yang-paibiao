...
func (r *userServiceRouter) register() {
	...
	r.iRouter.Handle("POST", "/api/v1/user/updateUserInfo", r.withMiddleware("POST", "/api/v1/user/updateUserInfo", r.UpdateUserInfo_0)...)
	r.iRouter.Handle("POST", "/api/v1/user/changePassword", r.withMiddleware("POST", "/api/v1/user/changePassword", r.ChangePassword_0)...)
