...
COMMENT ON COLUMN leagues.id IS '群组ID';
...
COMMENT ON COLUMN teams.league_id IS '群组ID';
...
COMMENT ON COLUMN logs.league_id IS '群组ID';
...
CREATE INDEX idx_logs_league_id ON logs(league_id);
